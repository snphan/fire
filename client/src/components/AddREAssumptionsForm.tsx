    ...
    <>
      <div className={(className ? className : "") + " flex flex-col"}>
        <div className="lg:hidden relative">
          <button className={(openEditAssumptions ? "-top-4 " : "top-0 ") + "animate-bounceMiddle absolute rounded-full p-2  bg-gradient-to-tr from-sky-400 to-sky-700 w-10 h-10 left-1/2 -translate-x-1/2 drop-shadow-strong"} onClick={() => setOpenEditAssumptions(false)}>
