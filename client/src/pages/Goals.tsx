            ...
            <DialogBody className="text-zinc-400 font-ubuntu grow">
              {isBankLinked?.bankAccountLinked ?
                ...
                <div className="flex flex-col justify-start items-center">
                  <div className="font-thin text-center mb-10">Please link your bank account in Dashboard</div>
                  <Button onClick={handleOpenAddGoal} className="font-[Ubuntu]">Back</Button>
                </div>
              }
            </DialogBody>
          </>
